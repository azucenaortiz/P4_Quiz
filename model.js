...
// Es un array de objetos, donde cada objeti tiene os atributos question
...
/**
* Carga las preguntas guardadas en e fichero
*
...
const load = () => {
  fs.readFile(DB_FILENAME, (err, data) => {
    if(err) {
      //la primera vez no existe el dichero
      if(err.code === "ENOENT") {
...
* Si se produce algun tipode error, se lanza una excepción que abortará 
...
//
/**
* Devuelve el número total de pregutas existentes.
*
